...
router.post("/users/:userId/approve-mess", (0, validation_1.validate)(user_schemas_1.approveMessJoinSchema), (0, auth_1.restrictTo)(user_interface_1.UserRole.Admin, user_interface_1.UserRole.Manager), user_controller_1.approveMessJoinController);
...
router.patch("/users/:userId", (0, validation_1.validate)(user_schemas_1.updateUserSchema), (0, auth_1.restrictTo)(user_interface_1.UserRole.Admin), user_controller_1.updateUserController);
...
router.delete("/users/:userId", (0, validation_1.validate)(user_schemas_1.softDeleteUserSchema), (0, auth_1.restrictTo)(user_interface_1.UserRole.Admin), user_controller_1.softDeleteUserController);
router.post("/users/:userId/activity-log", (0, validation_1.validate)(user_schemas_1.addActivityLogSchema), (0, auth_1.restrictTo)(user_interface_1.UserRole.Admin), user_controller_1.addActivityLogController);
// Admin routes
router.post("/users", (0, validation_1.validate)(user_schemas_1.createUserSchema), (0, auth_1.restrictTo)(user_interface_1.UserRole.Admin), user_controller_1.createUserController);
